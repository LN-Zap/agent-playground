...
The project documentation is built with [MkDocs](https://www.mkdocs.org/) using the [techdocs-core](https://github.com/backstage/mkdocs-techdocs-core) plugin for Backstage integration.
...
The built documentation will be available in the `site/` directory. The development server runs at `http://127.0.0.1:8000`.
...
- `docs/reference/` - Reference documentation for tools and agents
