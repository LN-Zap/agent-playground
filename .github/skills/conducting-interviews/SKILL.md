...
description: >-
  Conducts technical interviews to stress-test plans and specifications. Use
  when refining a technical plan, creating specifications, validating
  architecture decisions, or identifying trade-offs before implementation.
---
