...
description: Executes strike CLI commands for user creation, funding, bitcoin operations, loans, and cash transactions. Use when creating users, minting users, funding accounts, buying/selling bitcoin, originating loans, making deposits/withdrawals, or any strike command.
---
