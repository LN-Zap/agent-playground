...
description: >-
  Analyzes completed tasks to identify friction, errors, and improvement
  opportunities. Use after completing complex tasks, correcting architectural
  violations, encountering recurring issues, or when a task took longer than
