...
description: >-
  Stress-tests and optimizes agent skills through autonomous sub-agent
  delegation. Use when evaluating reliability of an existing skill, identifying
  friction points and missing context, performing quality assurance on new or
  updated skills, or systematically grading skill effectiveness before release.
  Domain-agnostic protocol applicable to any skill type.
---
