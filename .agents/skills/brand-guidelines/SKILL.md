...
description: Applies Strike's official brand identity to visual artifacts including presentations, web pages, dashboards, diagrams, and AI-generated images. Use when brand colors, typography, logo usage, or Strike's "Neo-Industrial Fintech" aesthetic applies. Triggers on requests for Strike styling, dark mode UI, brand consistency, or visual design following company standards.
---
